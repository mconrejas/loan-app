          ...
          <Toolbar>
            ...
            <Stack direction="row" spacing={2}>
              ...
              <Menu anchorEl={anchorEl} open={open} onClose={handleClose}>
                <MenuItem onClick={handleClose} sx={{ fontSize: '0.86rem' }}>Membership Application</MenuItem>
                <MenuItem onClick={handleClose} sx={{ fontSize: '0.86rem' }}>Loan Application</MenuItem>
              </Menu>
              <Button
                color="inherit"
